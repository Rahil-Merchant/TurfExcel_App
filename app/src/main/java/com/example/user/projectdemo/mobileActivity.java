...
public class mobileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextCode=findViewById(R.id.mob_mob);
        String pNo= getIntent().getStringExtra("pNo");
        mAuth=FirebaseAuth.getInstance();
        sendVerificationCode(pNo);
        findViewById(R.id.verifMob_btn).setOnClickListener(new View.OnClickListener() {
        @Override
                ...
                .addOnCompleteListener(mobileActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(mobileActivity.this, "Phone number verified", Toast.LENGTH_SHORT).show();
